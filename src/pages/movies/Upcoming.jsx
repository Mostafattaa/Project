...
const Upcoming = ({movies ,setMovies  ,handlePageChange, currentPage}) => {
    ...
    const fetchNowPlaying = async () => {
      try {
        const response = await fetch(
          `https://api.themoviedb.org/3/movie/upcoming?api_key=0ed57fe834b6ef78ccf55dfd4fab28f0&page=${currentPage}`
        );
