...
const NowPlaying = ({movies ,setMovies ,handlePageChange, currentPage}) => {
    ...
    const fetchNowPlaying = async () => {
      try {
        const response = await fetch(
          `https://api.themoviedb.org/3/movie/now_playing?api_key=0ed57fe834b6ef78ccf55dfd4fab28f0&page=${currentPage}`
        );
  ...
  return (
    <div className="mx-auto p-5 bg-gray-300 dark:bg-gray-900 text-black dark:text-white">
      <h2 className="text-2xl font-bold mb-4 text-center">Now Playing Movies</h2>
